...
enum {
    BUFFER_BINDING_VERTICES,
    BUFFER_BINDING_TEXTURE_HANDLES,
    BUFFER_BINDING_COMMANDS,
    BUFFER_BINDING_INSTANCES_DATA,
    BUFFER_BINDING_USED_INSTANCES_IDS,
    BUFFER_BINDING_INSTANCES_MESH_IDS,
    BUFFER_BINDING_TERRAIN_VERTICES
};
